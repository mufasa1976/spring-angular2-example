...
public class HelloWorldControllerImpl implements HelloWorldController {
  ...
  @Override
  @PreAuthorize("#oauth2.hasScope('read') and hasAnyRole('ROLE_GROUP1', 'ROLE_GROUP2', 'ROLE_GROUP3')")
  ...
  @Override
  @PreAuthorize("#oauth2.hasScope('read') and hasRole('ROLE_GROUP1')")
  ...
  @Override
  @PreAuthorize("#oauth2.hasScope('read') and hasRole('ROLE_GROUP3')")
  public HelloWorldResource create(@RequestBody HelloWorldResource resource) {
    return helloWorldService.create(resource);
  }

  @Override
  @PreAuthorize("#oauth2.hasScope('read') and hasRole('ROLE_GROUP2')")
